    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ url('admin/roles') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
            <h1>Edit Role</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard.index') }}">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="{{ url('admin/roles') }}">Roles</a></div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    value="{{ $permission->id }}"
                                                                    {{ collect(old('permissions', $rolePermissionIds))->contains($permission->id) ? 'checked' : '' }}>
